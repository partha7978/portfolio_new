              ...
              <motion.div className="app__skills-exp-works">
                  <>
                    <motion.div
                      ...
                      data-tooltip-content={`${education.specialization ? 'Specialization : ' : '' } ${education.specialization ?? education.specialization}`}
                    >
                      ...
                      <p style={{fontWeight: '600'}} className="p-text">{education.marks}</p>
                    </motion.div>
